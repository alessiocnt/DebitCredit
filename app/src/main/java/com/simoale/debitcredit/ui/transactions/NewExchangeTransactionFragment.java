...
public class NewExchangeTransactionFragment extends Fragment {
    ...
    String walletFromSelected;
    String walletToSelected;
        ...
        if (activity != null) {
            ...
            saveBtn.setOnClickListener(v -> {
                try {
                    ...
                    if (Utilities.checkDataValid(amountString, categorySelected, dateSelected, walletFromSelected, walletToSelected)) {
                        Float amount = Math.abs(Float.parseFloat(amountString.replace(',', '.')));
...
//                        walletViewModel.updateBalance(currentToWallet.getId(), amount);
    ...
    private void setupChips() {
        // Category chip group
        ChipGroup categoryChipGroup = getView().findViewById(R.id.transaction_exchange_category_chip_group);
        setupCategoryChips(categoryChipGroup);
        // Payee chip group
        ChipGroup payeeChipGroup = getView().findViewById(R.id.transaction_exchange_payee_chip_group);
        setupPayeeChips(payeeChipGroup);
        // Wallet from chip group
        ChipGroup walletFromChipGroup = getView().findViewById(R.id.transaction_exchange_from_wallet_chip_group);
        setupWalletFromChips(walletFromChipGroup);
        // Wallet to chip group
        ChipGroup walletToChipGroup = getView().findViewById(R.id.transaction_exchange_to_wallet_chip_group);
        setupWalletToChips(walletToChipGroup);
        // Tag chip group
        ChipGroup tagChipGroup = getView().findViewById(R.id.transaction_exchange_tag_chip_group);
    ...
    private void setupWalletFromChips(ChipGroup walletChipGroup) {
        ...
        walletChipGroup.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(ChipGroup chipGroup, int i) {
                Chip chip = chipGroup.findViewById(i);
                // Set the chosen category
                walletFromSelected = chip.getText().toString();
            }
        });
    }
    ...
    private void setupWalletToChips(ChipGroup walletChipGroup) {
        ...
        walletChipGroup.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(ChipGroup chipGroup, int i) {
                Chip chip = chipGroup.findViewById(i);
                // Set the chosen category
                walletToSelected = chip.getText().toString();
            }
        });
    }
    ...
    private void setupDatePicker() {
        ImageButton calendar = getView().findViewById(R.id.transaction_exchange_calendar);
    ...
    public void setupUi() {
        this.amountEditText = activity.findViewById(R.id.transaction_exchange_amount_TextInput);
        this.descriptionEditText = activity.findViewById(R.id.transaction_exchange_description_TextInput);
        this.dateDisplay = activity.findViewById(R.id.transaction_exchange_date_display);
        this.noteEditText = activity.findViewById(R.id.transaction_exchange_note_TextInput);
        this.locationText = activity.findViewById(R.id.transaction_exchange_location_text);
        this.locationSwitch = activity.findViewById(R.id.transaction_exchange_switch_location);
        this.captureBtn = activity.findViewById(R.id.transaction_exchange_capture_button);
