...
public class NewTransactionFragmentOut extends Fragment {
    ...
    public NewTransactionFragmentOut(TransactionType type) {
    ...
    private void setupChips() {
        // Category chip group
        ChipGroup categoryChipGroup = getView().findViewById(R.id.transaction_out_category_chip_group);
        setupCategoryChips(categoryChipGroup);
        // Payee chip group
        ChipGroup payeeChipGroup = getView().findViewById(R.id.transaction_out_payee_chip_group);
        setupPayeeChips(payeeChipGroup);
        // Wallet chip group
        ChipGroup walletChipGroup = getView().findViewById(R.id.transaction_out_wallet_chip_group);
        setupWalletChips(walletChipGroup);
        // Tag chip group
        ChipGroup tagChipGroup = getView().findViewById(R.id.transaction_out_tag_chip_group);
    ...
    private void setupPayeeChips(ChipGroup payeeChipGroup) {
        ...
        ImageButton add = getView().findViewById(R.id.transaction_out_add_payee);
    ...
    private void setupDatePicker() {
        ImageButton calendar = getView().findViewById(R.id.transaction_out_calendar);
