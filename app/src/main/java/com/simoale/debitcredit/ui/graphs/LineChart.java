...
public class LineChart implements Chart {
    ...
    List<Pair<String, List<DataEntry>>> data;

    public LineChart(AnyChartView anyChartView, List<Pair<String, List<DataEntry>>> data, String title, String xLabel, String yLabel) {
